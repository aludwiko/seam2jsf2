...
public class HibernateSessionInvocationHandler implements InvocationHandler, Serializable, EventSource
{
   ...
   public LoadQueryInfluencers getLoadQueryInfluencers()
   {
      ...
      return ((EventSource) delegate).getLoadQueryInfluencers();
   }

   public void applyNonFlushedChanges(NonFlushedChanges arg0) throws HibernateException
   {
      ((EventSource) delegate).applyNonFlushedChanges(arg0);
      
   }

   public NonFlushedChanges getNonFlushedChanges() throws HibernateException
   {
      return ((EventSource) delegate).getNonFlushedChanges();
   }

   public LockRequest buildLockRequest(LockOptions arg0)
   {
      return ((EventSource) delegate).buildLockRequest(arg0);
   }

   public Object get(Class arg0, Serializable arg1, LockOptions arg2) throws HibernateException
   {
      return ((EventSource) delegate).get(arg0, arg1, arg2);
   }
   ...
   {
      return ((EventSource) delegate).load(arg0, arg1,arg2);
   }
