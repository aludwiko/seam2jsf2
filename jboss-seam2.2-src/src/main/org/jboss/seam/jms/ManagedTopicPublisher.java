...
public class ManagedTopicPublisher
{
   ...
   private ValueExpression<Topic> springTopic;
   public ValueExpression<Topic> getSpringTopic()
   {
      return springTopic;
   }

   public void setSpringTopic(ValueExpression<Topic> springTopic)
   {
      this.springTopic = springTopic;
   }
   ...
   {
      return "TopicConnection(" + springTopic!=null?springTopic.getExpressionString():topicJndiName + ")";
   }
